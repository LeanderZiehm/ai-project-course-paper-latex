...
DISCLAIMER: Because the models returned an empty string, those values were rated as false, therefore resulting in a lower accuracy for Anonymisation methods.
